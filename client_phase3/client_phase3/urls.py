...
urlpatterns = [
    ...
    path("views/", views_view, name="views"),
    ...
    path("attach_view/", attach_view, name="attach_view"),
    path("detach_view/", detach_view, name="detach_view"),
    path("add_to_view/", add_to_view, name="add_to_view"),
]
